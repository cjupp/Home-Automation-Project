...
void oledPrintTime(void * parameters)
{
    ...
    sprintf(oledBuff, "%s,\n%s %d\n%d\n%02d:%02d:%02d", weekdays[esp32Time.tm_wday], months[esp32Time.tm_mon], esp32Time.tm_mday, (esp32Time.tm_year + 1900), esp32Time.tm_hour, esp32Time.tm_min, esp32Time.tm_sec);
