...
#include <OLED_Expansion.h>
#include <OLED_HMI.h>
#include <Serial_Tools>
...
extern Adafruit_SSD1306 oledDisplay(SCREEN_WIDTH, SCREEN_HEIGHT, &Wire, OLED_RESET);

// Declare the analog stick used for the project using the defined pins and threshold
extern analogStick joystick(XPIN, YPIN, BPIN, 2000);
